...
def train(args):
    ...
    for epoch in range(1, args.total_epoch + 1):
        ...
        for data in trainloader:
            ...
            total_loss = loss_cls + loss_center * args.weight_center
            total_loss.backward()
            ...
            if total_iters % 100 == 0:
                ...
                tb_log.add_scalar('train/softmax_loss', loss_cls.item(), total_iters)
                tb_log.add_scalar('train/center_loss', loss_center.item(), total_iters)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_center', type=float, default=0.01, help='')
